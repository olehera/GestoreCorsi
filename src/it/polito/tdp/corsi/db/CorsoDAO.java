...
public class CorsoDAO {
	...
	public Map<Corso, Integer> getIscrittiCorsi(int periodo) {
		String sql = "SELECT c.codins, c.crediti, c.nome, c.pd, COUNT(*) AS tot FROM corso AS C, iscrizione as i WHERE c.codins = i.codins AND c.pd = ? GROUP BY c.codins, c.crediti, c.nome, c.pd";
